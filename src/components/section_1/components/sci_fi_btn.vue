...
.button-border::before {
  ...
  filter: drop-shadow(0 0 5px #7b61ff);
}
...
.sci-fi-btn {
  padding: 3rem 0;
  /* Add scaling support for high DPI displays */
  transform-origin: center;
...
/* Additional Windows scaling support */
  ...
  <div class="sci-fi-btn">
    ...
    <div class="button-container">
      ...
      <div class="digital-glyphs">
        <div class="digital-glyph">Future 125x</div>
        <div class="digital-glyph">Spot</div>
        <div class="digital-glyph">
          01011010 01000001 01010000 01010101 01010011 01001011
        </div>
        <div class="digital-glyph">Cryptocurrency</div>
      </div>
